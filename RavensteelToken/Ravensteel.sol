...
contract RavensteelToken is IERC20 { 
     
    using SafeMath for uint256;
    //public variables
    string public constant symbol="Ravensteel"; 
    string public constant name="Ravensteel";
    ...
    function RavensteelToken(address _holder,address _foundation,address _team) public payable{
        require(_holder != 0x0);
